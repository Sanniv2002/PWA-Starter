...
const msgContents = () => {
    ...
    return (
        <div id="scrollableDiv" className='flex flex-col-reverse flex-grow overflow-y-auto'>
            <InfiniteScroll
            ...
            >
                {messages?.map(msg => (
                    <span key={msg.id}>
                        {Message(msg.sender.image, msg.message, msg.sender.is_kyc_verified, msg.sender.self)}
                    </span>
                ))}
            </InfiniteScroll>
